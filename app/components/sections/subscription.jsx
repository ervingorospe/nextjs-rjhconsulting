...
export async function Subscription({ data, sectionCount }) {
  const { fields } = data
  ...
  return (
    <Section className="relative overflow-hidden" bg={bg}>
      <Container width={width} margin="section" className="relative">
        <Motion className="grid justify-center">
          {/* title */}
          ...
          
          {
            _.get(fields, 'embed') && (
              <>
                ...
                <stripe-buy-button
                  buy-button-id="buy_btn_1OMaPxIAmik5qHaghw26n8c0"
                  publishable-key="pk_live_51O0TNiIAmik5qHagkzfhNRAHYWkRzRyh6sieRe8MeubxE9BbUW85qxo4TIgWEUy89IufvuoyphOmuT86A7hVNKhH00FVV0zP5O"
                >
                </stripe-buy-button>
              </>
            )
