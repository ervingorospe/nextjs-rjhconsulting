...
export async function FormDefault({ data, sectionCount }) {
  const { fields } = data
  ...
  return (
    <Section className="relative overflow-hidden" bg={bg}>
      <Container width={width} margin="section" className="relative">
        <Motion className="bg-gray-50 rounded-xl px-6 pt-6">
          {/* title */}
          ...
          <FormWufoo data={data} className="relative w-full min-h-[399px] mt-6"/>
        </Motion>
      </Container>
    </Section>
  )
