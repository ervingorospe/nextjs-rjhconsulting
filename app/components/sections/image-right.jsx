  ...
  return (
    <Section className="relative" bg={bg}>
      <Container width={width} margin="section" className="relative z-1">
        <Motion className="mt-6 grid items-center gap-10 md:mt-8 lg:mt-6 lg:grid-cols-2 xl:gap-x-12">
          {
            _.get(fields, 'videoUrl') ? (
              <MotionVariant variants={fadeInFromTop} className="h-full w-full">
                <figure className="h-full w-full overflow-hidden rounded-xl shadow-xl">
