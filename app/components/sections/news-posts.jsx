...
export async function NewsPosts({ data, sectionCount }) {
  const { fields } = data
      ...
      <Container className="relative z-1 mx-auto" width={width} margin="section">
...

        {
          subCollection.length > 0 && (
            <Blogs blogs={subCollection} authors={authors} slugPrefix="/resources/rjh-in-the-news" pageSlugPrefix="/resources/news"/>
          )
        }
      </Container>
    </Section>
