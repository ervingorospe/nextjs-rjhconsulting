...
export function FreeDiscoveryForm({ data, sectionCount }) {
  const { fields } = data
    ...
    <Section className="relative overflow-hidden" bg={bg}>
      ...
      <Container className="relative z-1" width={width} margin="hero">
        <div className="grid gap-8 lg:grid-cols-2 items-center">
          <Motion>
            ...
            <MotionVariant variants={fadeInFromBottom}>
              <Body
                ...
                size={bodySize}
                className={`text-4xl md:text-5xl xl:text-6xl font-heading font-bold text-white ${_.get(fields, 'bodyClass') ?? _.get(fields, 'bodyClass')}`}
              />
            </MotionVariant>
          ...
          <FormWufoo data={data} className="mx-auto bg-gray-50 rounded-xl px-6 pt-6 w-full max-h-[599px] max-w-[600px] mt-6" titleText="Get In Touch"/>
        </div>
      </Container>
